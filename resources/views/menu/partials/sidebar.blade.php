 ...
 <header id="site_header" class="header mobile-menu-hide">
    <div class="header-content clearfix">
      <div class="my-photo">
        <img src="images/photo.jpg" alt="image" style="border-radius: 50%;">
      </div>

      <div class="site-title-block">
        <div class="site-title">Fityan Ali Munshi</div>
      </div>
      ...
      <div class="social-links">
        <a href="https://github.com/webtoor" target="_blank"><i class="fab fa-github"></i></a>
        <a href="#"><i class="fab fa-twitter"></i></a>
        <a href="https://www.facebook.com/fityanalimunshi" target="_blank"><i class="fab fa-facebook-f"></i></a>
      </div>
      <!-- / Social Links -->
